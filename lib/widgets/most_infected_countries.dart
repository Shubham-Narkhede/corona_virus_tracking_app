...
class _MostInfectedCountriesState extends State<MostInfectedCountries> {
  ...
  void initState() {
    ...
    switch (widget.index) {
      case 0:
        _currentColorLight = Colors.deepOrangeAccent;
        _currentColorDark = Colors.red.shade900;
        break;
      case 1:
        _currentColorLight = Colors.yellow;
        _currentColorDark = Colors.orange.shade800;
        break;
      case 2:
        _currentColorLight = Colors.lightBlueAccent;
        _currentColorDark = Colors.blue.shade700;
        break;
      case 3:
        _currentColorLight = Colors.white;
        _currentColorDark = Colors.green.shade700;
        break;
      case 4:
        _currentColorLight = Colors.white70;
