...
import 'package:coronavirustrackingapp/widgets/change_country_popup.dart';
import 'package:coronavirustrackingapp/widgets/most_infected_countries_shimmer.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:http/http.dart' show Client;
import 'package:coronavirustrackingapp/models/countries_list.dart';
import 'package:coronavirustrackingapp/models/country_detail.dart';
import 'package:coronavirustrackingapp/models/country_name.dart';
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            decoration: BoxDecoration(
               gradient: LinearGradient(colors: [ Colors.yellowAccent,
                 Colors.orange,
                 Colors.red.shade900]),
              borderRadius: BorderRadius.circular(15.0),
            ),
